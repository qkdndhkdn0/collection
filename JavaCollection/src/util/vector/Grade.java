...
/*========생성자==========*/
	public Grade() {} //아래처럼 파라미터가 있는 생성자를 만들면 디폴트를 별도로 추가해줘야함
	
	//setter 대신에 생성자로 학번,이름,3과목 점수를 입력받음
...
/*========멤버메소드==========*/
	...
	/*
	 ...
	 파라미터 갯수나 혹은 타입이 다르면 서로 다른 메소드로 인식한다.
	 이를 객체지향 4대 특징중 하나인 다양성에서 
	 "오버로딩"이라고 한다.
	 
	 주의!!! 오버라이딩은 상속관계,혹은 구현관계에서
	 @override라고 붙은 메소드를 말함
	 */
